     ...
     <div class="dropdown dropdown-profile">
         ...
         <?php
          ...
          if ($query->rowCount() > 0) {
            foreach ($results as $row) {               ?>
             <span class="logged-name"><span class="hidden-xs-down" style="font-size:1.7rem; color:white;"><?php echo $row->FirstName; ?></span> <i class="" style="font-size:1.7rem;"><b>></b></i></i></span><?php $cnt = $cnt + 1;
                                                                                                                                                                                                            }
                                                                                                                                                                                                          } ?>
       </a>
       <div class="dropdown-menu wd-200">
         <ul class="list-unstyled user-profile-nav">
           ...
           <li><a href="logout.php" style="border-bottom: none !important;"><i class="icon ion-power"></i> Sign Out</a></li>
         </ul>
       </div><!-- dropdown-menu -->
     </div><!-- dropdown -->
   </div><!-- am-header-right -->
 </div><!-- am-header -->
 <!-- class="fa fa-angle-down mg-l-3" -->