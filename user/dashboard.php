    ...
    <div class="am-mainpanel">
      <div class="am-pagetitle">
        ...
        <form id="searchBar" class="search-bar" action="index.html">
          ...
          <button id="searchBtn" class="btn"><i class="icon ion-search" style="color:white;"></i></button>
        </form><!-- search-bar -->
      </div><!-- am-pagetitle -->
...
{               ?>
                    <h4 class="welcome-na">Welcome to Our System || <?php  echo $row->FirstName;?> <?php  echo $row->LastName;?></h4><?php $cnt=$cnt+1;}} ?>
